          ...
          <div className="h-0 flex-1 flex flex-col overflow-y-auto">
            ...
            <Menu as="div" className="px-3 mt-6 relative inline-block text-left">
              {({ open }) => (
                <>
                  <div>
                    <Menu.Button className="group w-full bg-gray-100 rounded-md px-3.5 py-2 text-sm text-left font-medium text-gray-700 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-y-3">
                      <span className="flex w-full justify-between items-center">
                        <span className="flex min-w-0 items-center justify-between space-x-3">
                          <img
                            className="w-10 h-10 bg-gray-300 rounded-full flex-shrink-0"
                            src="https://avatars.githubusercontent.com/u/33829929?v=4"
                            alt=""
                          />
                          <span className="flex-1 flex flex-col min-w-0">
                            <span className="text-gray-900 text-sm font-medium truncate">Jamie Legg</span>
                            <span className="text-gray-500 text-sm truncate">@jamie</span>
                          </span>
                        </span>
                        <SelectorIcon
